 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_fechas/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroFecha
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_fecha", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroFecha
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroFechas")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroFechas")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroFecha
     */
