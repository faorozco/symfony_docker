 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_horas/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroHora
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_hora", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroHora
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroHoras")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroHoras")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroHora
     */
