 ...
 *      "storeformats"={
 *          "method"="POST",
 *          "path"="/formatos/{id}/store",
 *          "controller"=StoreFormat::class,
 *          "defaults"={"_api_receive"=false}
 *      },
 *      "generarpdfformatos"={
 *          "method"="POST",
 *          "path"="/formatos/{id}/generatepdf",
 ...
 * @ORM\Table(name="formato", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_formato_plantilla_version1_idx", columns={"plantilla_version_id"}), @ORM\Index(name="fk_formato_archivo1_idx", columns={"archivo_id"})})
 */
class Formato
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="formatos")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="PlantillaVersion", inversedBy="formatos")
     * @ORM\JoinColumn(name="plantilla_version_id", referencedColumnName="id", nullable=false)
     */
    protected $plantillaVersion;

    /**
     * @ORM\OneToOne(targetEntity="Archivo", inversedBy="formato")
