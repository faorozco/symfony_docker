 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_numerico_decimals/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroNumericoDecimal
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_numerico_decimal", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroNumericoDecimal
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroNumericoDecimals")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroNumericoDecimals")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroNumericoDecimal
     */
