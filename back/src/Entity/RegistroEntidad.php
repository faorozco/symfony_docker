 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_entidads/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroEntidad
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_entidad", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroEntidad
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroEntidads")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroEntidads")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroEntidad
     */
    ...
    {
        return array('id', 'registro_id', 'campo_formulario_version_id', 'id_entidad', 'estado_id');
    }
