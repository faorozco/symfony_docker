 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_texto_largos/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroTextoLargo
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_texto_largo", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroTextoLargo
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroTextoLargos")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroTextoLargos")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroTextoLargo
     */
