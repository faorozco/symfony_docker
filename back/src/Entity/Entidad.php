...
use App\Controller\EntidadCampo;
use App\Controller\Entidad\EntidadColumnas;
 ...
 *      "getEspecial"={
 *         "method"="GET",
 *         "path"="/entidades/campo",
 *         "controller"=EntidadCampo::class,
 *         "defaults"={"_api_receive"=false}
 *        },
 *      "getColumnas"={
 *         "method"="GET",
 *         "path"="/entidades/columnas/{id}",
 *         "controller"=EntidadColumnas::class,
 *         "defaults"={"_api_receive"=false}
 *        },
 *  }
 * )
...
class Entidad
{
    ...
    public function getNombreVisualizar(): ?string
    {
        return $this->nombre_visualizar;
    }

    public function setNombreVisualizar(string $nombre_visualizar): self
    {
        $this->nombre_visualizar = $nombre_visualizar;
