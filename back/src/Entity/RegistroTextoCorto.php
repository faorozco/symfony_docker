 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_texto_cortos/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroTextoCorto
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_texto_corto", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroTextoCorto
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroTextoCortos")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroTextoCortos")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroTextoCorto
     */
