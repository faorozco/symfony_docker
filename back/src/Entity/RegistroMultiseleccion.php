 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_multiseleccions/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroMultiseleccion
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_multiseleccion", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"}), @ORM\Index(name="fk_registro_multiseleccion_detalle_lista1_idx", columns={"detalle_lista_id"})})
 */
class RegistroMultiseleccion
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroMultiseleccions")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroMultiseleccions")
     * @ORM\JoinColumn(name="campo_formulario_version_id", referencedColumnName="id", nullable=false)
     */
    protected $campoFormularioVersion;

    /**
     * @ORM\ManyToOne(targetEntity="DetalleLista", inversedBy="registroMultiseleccions")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroMultiseleccion
     */
    ...
    {
        return array('id', 'registro_id', 'campo_formulario_version_id', 'detalle_lista_id', 'estado_id');
    }
}
