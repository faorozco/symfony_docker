 ...
 *      "get"={
 *         "method"="GET",
 *         "path"="/registro_numerico_enteros/{id}",
 *          "requirements"={"id"="\d+"}
 *        }
 *  }
 * )
 * App\Entity\RegistroNumericoEntero
 *
 * @ORM\Entity()
 * @ORM\Table(name="registro_numerico_entero", indexes={@ORM\Index(name="fk_Registro_numerico_Registro1_idx", columns={"registro_id"}), @ORM\Index(name="fk_Registro_numerico_campo_formulario_version1_idx", columns={"campo_formulario_version_id"})})
 */
class RegistroNumericoEntero
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Registro", inversedBy="registroNumericoEnteros")
     * @ORM\JoinColumn(name="registro_id", referencedColumnName="id", nullable=false)
     */
    protected $registro;

    /**
     * @ORM\ManyToOne(targetEntity="CampoFormularioVersion", inversedBy="registroNumericoEnteros")
     ...
     *
     * @param integer $id
     * @return \App\Entity\RegistroNumericoEntero
     */
