...
class CambiarArchivoService
{
    ...
    public function save(Request $request)
    {
        ...
        $newArchivo->setVersion($archivoLastVersion->getVersion());
        ...
        $archivoLastVersion->setArchivoOrigen(0);
        $archivoLastVersion->setEstadoId(0);
        $this->em->persist($archivoLastVersion);
        $this->em->flush();
